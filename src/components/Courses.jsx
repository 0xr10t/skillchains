...
const AVAILABLE_COURSES = [
  {
    ...
    duration: "8 weeks",
    difficulty: "Beginner",
    image: "/nft_images/course_1.webp",
    instructor: "John Doe",
    enrolled: 1234,
    rating: 4.8
  },
  {
    ...
    duration: "12 weeks",
    difficulty: "Advanced",
    image: "/nft_images/blockchain.jpeg",
        ...
        {AVAILABLE_COURSES.map(course => (
          <div key={course.id} className="course-card">
            <div className="course-image">
              <img src={"/Users/sohamvijay/Desktop/Cursor/public/nft_images/blockchain.jpeg"} alt={course.title} />
